...
class TellingControllerSpec extends Specification {
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        response.redirectedUrl == '/telling/show/1'
    ...
    void "Test the update action performs an update on a valid domain instance"() {
        ...
        response.reset()
        populateValidParams(params)
        telling = new Telling(params).save(flush: true)
        controller.update(telling)

        then: "A redirect is issues to the show action"
        response.redirectedUrl == "/telling/show/$telling.id"
        flash.message != null
    }
    ...
    void "Test that the delete action deletes an instance if it exists"() {
        ...
        response.reset()
        populateValidParams(params)
        def telling = new Telling(params).save(flush: true)
