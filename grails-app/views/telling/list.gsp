...
<div id="list-telling" class="content scaffold-list" role="main">
    ...
    <g:form url="[resource:tellingSearch, action:'list']">
        <fieldset class="form">
            <label for="narrativeGenre">
                <g:message code="telling.narrativeGenre.label" default="Narrative Genre" />
            </label>
            <g:select id="narrativeGenre" name="narrativeGenre.id" from="${narrativesGenre}" optionKey="id" class="many-to-one"/>
            <label for="tellingType">
                <g:message code="telling.tellingType.label" default="Telling Type" />
            </label>
            <g:select id="tellingType" name="tellingType.id" from="${tellingsType}" optionKey="id" class="many-to-one"/>
        </fieldset>
        <fieldset class="buttons">
            <g:submitButton name="list" class="property-list" value="${message(code: 'default.button.list.label', default: 'Listar')}" />
        </fieldset>
    </g:form>
    <table>
        <thead>
